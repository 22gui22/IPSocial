/*
	...
	*	Version 4.1
	*	Modified by: Guilherme Manteigas
...
var cd = new Array();
cd[0]="Desconhecida";
cd[1]="Vila Do Corvo|Lajes das Flores|Santa Cruz das Flores|Santa Cruz da Graciosa|Velas|Calheta|Horta|Madalena|São Roque do Pico|Lajes do Pico|Angra do Heroísmo|Praia da Vitória|Ponta Delgada|Ribeira Grande|Nordeste|Lagoa|Villa Franca Do Campo|Povoação|Vila do Porto";
cd[2]="Mealhada|Anadia|Ovar|Vagos|Aveiro|Albergaria-a-Velha|Estarreja|Águeda|Sever do Vouga|Oliveira do Bairro|Murtosa|Ílhavo|Santa Maria Da Feira|Oliveira de Azeméis|São João da Madeira|Arouca|Vale de Cambra|Espinho|Castelo de Paiva";
cd[3]="Odemira|Moura|Ourique|Ferreira do Alentejo|Mértola|Beja|Aljustrel|Cuba|Castro Verde|Barrancos|Serpa|Almodôvar|Alvito|Vidigueira";
cd[4]="Vizela|Vieira do Minho|Vila Nova de Famalicão|Póvoa de Lanhoso|Cabeceiras de Basto|Fafe|Guimarães|Barcelos|Esposende|Amares|Terras de Bouro|Braga|Vila Verde|Celorico de Basto";
cd[5]="Vimioso|Macedo de Cavaleiros|Vinhais|Miranda do Douro|Mogadouro|Alfândega Da Fé|Bragança|Mirandela|Vila Flor|Freixo de Espada à Cinta|Carrazeda De Ansiães|Torre de Moncorvo";
cd[6]="Idanha-a-Nova|Vila Velha de Ródão|Castelo Branco|Penamacor|Covilhã|Fundão|Belmonte|Proença-a-Nova|Oleiros|Vila de Rei|Sertã";
cd[7]="Condeixa-a-Nova|Cantanhede|Coimbra|Montemor-o-Velho|Mira|Figueira da Foz|Soure|Penacova|Pampilhosa da Serra|Tábua|Arganil|Oliveira do Hospital|Góis|Miranda do Corvo|Lousã|Vila Nova De Poiares|Penela";
cd[8]="Évora|Vila Viçosa|Redondo|Viana do Alentejo|Vendas Novas|Arraiolos|Montemor-o-Novo|Estremoz|Alandroal|Reguengos de Monsaraz|Portel|Borba|Mourão|Mora";
cd[9]="Olhão|Faro|Tavira|Alcoutim|Monchique|Lagos|Lagoa|Aljezur|Vila do Bispo|Albufeira|Loulé|Portimão|Vila Real de Santo António|São Brás de Alportel|Castro Marim|Silves";
cd[10]="Celorico da Beira|Figueira de Castelo Rodrigo|Almeida|Manteigas|Sabugal|Meda|Pinhel|Trancoso|Guarda|Aguiar da Beira|Gouveia|Fornos de Algodres|Seia|Vila Nova de Foz Côa";
cd[11]="Alvaiázere|Figueiró dos Vinhos|Castanheira de Pêra|Pedrógão Grande|Ansião|Porto de Mós|Pombal|Leiria|Batalha|Marinha Grande|Óbidos|Caldas da Rainha|Nazaré|Alcobaça|Peniche|Bombarral";
cd[12]="Mafra|Amadora|Lisboa|Vila Franca de Xira|Sintra|Odivelas|Loures|Cascais|Oeiras|Azambuja|Cadaval|Lourinhã|Alenquer|Torres Vedras|Sobral de Monte Agraço|Arruda dos Vinhos";
cd[13]="Câmara de Lobos|Caniço|Funchal|Machico|Santa Cruz|Santana";
cd[14]="Alter do Chão|Arronches|Avis|Campo Maior|Castelo de Vide|Crato|Elvas|Fronteira|Gavião|Marvão|Monforte|Nisa|Ponte de Sor|Portalegre|Sousel";
cd[15]="Arouca|Espinho|Gondomar|Maia|Matosinhos|Oliveira de Azeméis|Paredes|Porto|Póvoa de Varzim|Santa Maria da Feira|Santo Tirso|São João da Madeira|Trofa|Vale de Cambra|Valongo|Vila do Conde|Vila Nova de Gaia";
cd[16]="Abrantes|Alcanena|Almeirim|Alpiarça|Benavente|Cartaxo|Chamusca|Constância|Coruche|Entroncamento|Ferreira do Zêzere|Golegã|Mação|Ourém|Rio Maior|Salvaterra de Magos|Santarém|Sardoal|Tomar|Torres Novas|Vila Nova da Barquinha";
cd[17]="Sines|Santiago do Cacém|Alcácer do Sal|Grândola|Setúbal|Sesimbra|Almada|Barreiro|Alcochete|Montijo|Moita|Palmela|Seixal";
cd[18]="Ponte da Barca|Monção|Viana do Castelo|Caminha|Valença|Ponte de Lima|Vila Nova de Cerveira|Melgaço|Paredes de Coura|Arcos De Valdevez";
cd[19]="Vila Pouca de Aguiar|Valpaços|Montalegre|Boticas|Ribeira de Pena|Chaves|Mondim de Basto|Sabrosa|Peso da Régua|Santa Marta De Penaguião|Mesão Frio|Alijó|Murça|Vila Real";
cd[20]="Mortágua|Vouzela|Sátão|Viseu|Vila Nova de Paiva|São Pedro do Sul|Tondela|Nelas|Santa Comba Dão|Oliveira de Frades|Castro Daire|Carregal do Sal|Penalva do Castelo|Mangualde|Penedono|Tabuaço|Armamar|São João da Pesqueira|Tarouca|Sernancelhe|Lamego|Moimenta da Beira|Cinfães|Resende";

function cidades( countryElementId, stateElementId ){
	
	var cidadeElement = document.getElementById("cidade");
	var p = document.getElementById("country");
	var pais = p.selectedIndex;
	var d = document.getElementById("state");
	var distrito = d.selectedIndex;
	
	if(distrito == 1 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[1].split("|");
	}else if(distrito == 2 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[2].split("|");
	}else if(distrito == 3 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[3].split("|");
	}else if(distrito == 4 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[4].split("|");
	}else if(distrito == 5 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[5].split("|");
	}else if(distrito == 6 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[6].split("|");
	}else if(distrito == 7 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[7].split("|");
	}else if(distrito == 8 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[8].split("|");
	}else if(distrito == 9 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[9].split("|");
	}else if(distrito == 10 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[10].split("|");
	}else if(distrito == 11 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[11].split("|");
	}else if(distrito == 12 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[12].split("|");
	}else if(distrito == 13 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[13].split("|");
	}else if(distrito == 14 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[14].split("|");
	}else if(distrito == 15 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[15].split("|");
	}else if(distrito == 16 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[16].split("|");
	}else if(distrito == 17 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[17].split("|");
	}else if(distrito == 18 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[18].split("|");
	}else if(distrito == 19 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[19].split("|");
	}else if(distrito == 20 && pais == 184){
		cidadeElement.length=0;
		cidadeElement.options[0] = new Option('Escolhe a Cidade','');
		cidadeElement.selectedIndex = 0;
		var cid = cd[20].split("|");
	...
	for (var i=0; i<cid.length; i++) {
		cidadeElement.options[cidadeElement.length] = new Option(cid[i],cid[i]);
	}
}
...
function populateStates( countryElementId, stateElementId ){
	...
	stateElement.options[0] = new Option('Escolhe o Distrito','');
	...
	cidades( countryElementId, stateElementId );
}
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option('Escolhe o Pais','-1');
